...
# ==========================================================================================================
a_share1 = Ashare()
is_filter_stocks = True
if is_filter_stocks:
    keep_stock_ids_path = os.path.join(parent_folder, 'data', 'a_share', 'filter_stock_ids.csv')
else:
...
a_share1.feature_engineering(input_folder, save_folder, keep_stock_ids_path= keep_stock_ids_path)
# ==========================================================================================================
...
test_1_folder = os.path.join(parent_folder, 'data', 'a_share', 'a_share_labeled_data_test_1')
test_2_folder = os.path.join(parent_folder, 'data', 'a_share', 'a_share_labeled_data_test_2')
a_share1.label_data(input_folder, save_folder, split_test = True, test_1_folder = test_1_folder,
                    test_2_folder = test_2_folder, test_set_1_percent = 0.15, test_set_2_percent = 0.5)
# test_set_2_percent = the percentage of data moved from test set1 to test set 2
# # ==========================================================================================================
...
test_1_folder = os.path.join(parent_folder, 'data', 'a_share', 'a_share_regression_data_test_1')
test_2_folder = os.path.join(parent_folder, 'data', 'a_share', 'a_share_regression_data_test_2')

a_share1.regression(input_folder, save_folder, split_test = True, test_1_folder = test_1_folder,
                    test_2_folder = test_2_folder, test_set_1_percent = 0.15, test_set_2_percent = 0.5)
# # ==========================================================================================================
